...
import "../../Contracts/SimpleVrsCache.sol";
import "../../lib/forge-std/src/Test.sol";

contract EcdsaOpsTest is Test {
    SimpleVrsCacheEcrecover public ops;

    function setUp() public virtual {
        ops = new SimpleVrsCacheEcrecover();
    }
    ...
    function test7000Address() public {
        verify(7000);
    }

    function test26950Address() public {
        verify(26950);
    }
